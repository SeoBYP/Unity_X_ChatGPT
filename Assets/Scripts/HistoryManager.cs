...
public class HistoryManager : MonoBehaviour
{
    ...
    {
        GUIManager.onBackPromptChat += SaveConverSation;
        HistoryMessageContainerUI.onHistoryButtonClicked += RemoveConversation;
    }
    ...
    {
        _history.conversations.Remove(conversation);
    }
